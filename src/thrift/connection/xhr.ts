...
import IServiceClient, {
    ServiceClientClass
} from "../interface/IServiceClient";
                ...
                if (!client) {
                    this.emit(
                        ...
                        new TApplicationException(
                            TApplicationExceptionType.MISSING_SERVICE_CLIENT,
                            "Received a response to an unknown service client"
                        )
                    );
                }
